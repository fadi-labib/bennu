...
In this tutorial, you will assemble the Bennu quadcopter frame from 3D-printed parts
and carbon fiber tubes, install the electronics stack (ESC, flight controller, GPS),
mount the camera, and attach the landing gear. By the end, you will have a fully
assembled airframe ready for wiring and configuration.
...
!!! warning "Hot Surface"
    ...
    Soldering iron is hot — work on a heat-resistant surface.

### 2. Assemble Arms

!!! warning "Carbon Fiber Dust"

    Carbon fiber dust is harmful — cut in a well-ventilated area and wear a mask.
...
!!! warning "Overtightening"
    ...
    CF tubes crack under excessive torque — hand-tight is sufficient.
...
!!! tip
    ...
    Arrow on FC must point forward — double-check before securing.
...
!!! tip
    ...
    Test-fit all parts before applying CA glue.
...
!!! tip
    ...
    Keep the CSI ribbon cable away from ESC power wires to reduce interference.
